...
class Q_NETWORK_EXPORT SslUnsafeError
{
public:
    enum SslError {
        NoError,
...
Q_NETWORK_EXPORT uint qHash(const SslUnsafeError &key, uint seed = 0) Q_DECL_NOTHROW;

#ifndef QT_NO_DEBUG_STREAM
class QDebug;
Q_NETWORK_EXPORT QDebug operator<<(QDebug debug, const SslUnsafeError &error);
Q_NETWORK_EXPORT QDebug operator<<(QDebug debug, const SslUnsafeError::SslError &error);
#endif
