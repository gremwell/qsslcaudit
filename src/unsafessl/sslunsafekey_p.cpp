...
/*!
    \class SslUnsafeKey
    \brief The SslUnsafeKey class provides an interface for private and public keys.
    \since 4.3
...
/*!
    \fn void SslUnsafeKeyPrivate::clear(bool deep)
    \internal
 */

/*!
    \fn void SslUnsafeKeyPrivate::decodePem(const QByteArray &pem, const QByteArray &passPhrase,
                               bool deepClear)
    \internal
