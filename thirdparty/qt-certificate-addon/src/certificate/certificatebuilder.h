...
public:
    ...
    bool addAuthorityKeyIdentifier(const XSslCertificate &cacert);

    XSslCertificate signedCertificate(const XSslKey &key);
    XSslCertificate signedCertificate(const XSslCertificate &cacert, const XSslKey &cakey);
